...
class _YoutubeScreenState extends State<YoutubeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                                          ...
                                          child: Center(
                                              child: Column(
                                                children: [
                                                  InkWell(
                                                    onTap: () {
                                                      Get.snackbar('aa', 'sooooo');
                                                      // _ytController.onClickRowButton(
                                                      //     workytUtils[i].name, i);
                                                      // _ytFindController.isBtnClicked=workytUtils[i].name;
                                                    },
                                                    child: Center(
                                                      child: Image.asset(
      ...
      //       //       children: [
      //       //           Obx((){
      //       //             return Text('${_ytFindController.isLike}');
      //       //           }),
      //       //       ],
      //       //     ),
      //       //   ),
      ...
      //                                     width: 30,
      //                                     fit: BoxFit.fill,
      //                                     color: workytUtils[i].name ==
      //                                             _ytFindController.isLike
      //                                         ? Colors.black
      //                                         : Colors.grey,
      //                                   ),
      //                                 ),
      ...
      //                 runSpacing: 20,
      //                 children: [
      //                   for (int i = 0; i < workytUtils2.length; i++)
      //
      // Obx(() {return Text('GGGG');})
      //
      //                     // Obx(() {
      //                     //   return Container(
      //                     //       width: 65,
